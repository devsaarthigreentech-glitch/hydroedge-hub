  ...
  return (
    <div style={{ padding: 24, height: "100%", overflow: "auto", background: THEME.background.secondary }}>
      ...
      <div style={{ background: "white", borderRadius: 12, border: `2px solid ${THEME.border.light}`, padding: 24, maxWidth: 700, boxShadow: THEME.shadow.sm }}>
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          {showHealthHint && (
            <div style={{
              ...
              <span>⚡</span>
              {series?.brand} system health monitoring will be enabled for this device
            </div>
          )}
        </div>
        ...
        {/* Set point — stored as the RAW Ain.1 value, drives the ±10% deviation
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <textarea
            ...
            placeholder="Internal notes about this device (optional)"
            rows={3}
            style={textareaStyle}
            onFocus={focusStyle}
            onBlur={blurStyle}
